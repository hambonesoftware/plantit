# Media Pipeline (Uploads, EXIF, Thumbnails) — Checker Agent

## Goal
Verify the Media Pipeline (Uploads, EXIF, Thumbnails) work meets acceptance criteria and global guardrails.

## Inputs
- Repo after execution.
- Artifacts: `artifacts/Phase-02_Media_Uploads_Thumbs_EXIF/summary.json` (if present).
- Global Guardrails.
...
## Required Output
Produce a **`checker_report_Phase-02_Media_Uploads_Thumbs_EXIF.md`** with:
