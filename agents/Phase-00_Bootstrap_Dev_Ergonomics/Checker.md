# Bootstrap & Dev Ergonomics — Checker Agent

## Goal
Verify the Bootstrap & Dev Ergonomics work meets acceptance criteria and global guardrails.

## Inputs
- Repo after execution.
- Artifacts: `artifacts/Phase-00_Bootstrap_Dev_Ergonomics/summary.json` (if present).
- Global Guardrails.
...
- Confirm live reload on backend and frontend changes
...
## Required Output
Produce a **`checker_report_Phase-00_Bootstrap_Dev_Ergonomics.md`** with:
