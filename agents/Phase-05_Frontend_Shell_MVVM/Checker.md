# Frontend Foundation (Shell + MVVM plumbing) — Checker Agent

## Goal
Verify the Frontend Foundation (Shell + MVVM plumbing) work meets acceptance criteria and global guardrails.

## Inputs
- Repo after execution.
- Artifacts: `artifacts/Phase-05_Frontend_Shell_MVVM/summary.json` (if present).
- Global Guardrails.
...
- Manual a11y check: focus indicators visible and discoverable
...
## Required Output
Produce a **`checker_report_Phase-05_Frontend_Shell_MVVM.md`** with:
