# Home (Villages) View — Checker Agent

## Goal
Verify the Home (Villages) View work meets acceptance criteria and global guardrails.

## Inputs
- Repo after execution.
- Artifacts: `artifacts/Phase-06_Home_View/summary.json` (if present).
- Global Guardrails.
...
## Required Output
Produce a **`checker_report_Phase-06_Home_View.md`** with:
