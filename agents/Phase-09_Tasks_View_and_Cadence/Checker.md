# Tasks View & Scheduling Quality — Checker Agent

## Goal
Verify the Tasks View & Scheduling Quality work meets acceptance criteria and global guardrails.

## Inputs
- Repo after execution.
- Artifacts: `artifacts/Phase-09_Tasks_View_and_Cadence/summary.json` (if present).
- Global Guardrails.
...
## Required Output
Produce a **`checker_report_Phase-09_Tasks_View_and_Cadence.md`** with:
