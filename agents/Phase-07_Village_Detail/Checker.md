# Village Detail View — Checker Agent

## Goal
Verify the Village Detail View work meets acceptance criteria and global guardrails.

## Inputs
- Repo after execution.
- Artifacts: `artifacts/Phase-07_Village_Detail/summary.json` (if present).
- Global Guardrails.
...
## Required Output
Produce a **`checker_report_Phase-07_Village_Detail.md`** with:
