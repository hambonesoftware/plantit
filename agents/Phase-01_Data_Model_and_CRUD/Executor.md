# Data Model & CRUD — Execution Agent
...
- A MACHINE-READABLE summary file at `artifacts/Phase-01_Data_Model_and_CRUD/summary.json` with:
...
## Implementation Plan
- Define SQLModel entities: Village, Plant, Task, Log, Photo, Settings
- Pydantic schemas for API I/O
- Routers for Villages, Plants, Tasks, Logs, Settings with full CRUD
...
- Round-trip tests for create→read→update→delete with cleanup
- Constraint tests (FKs, non-null, enum validation)

## Acceptance Criteria
- All new/modified endpoints respond as per OpenAPI
- No guardrail violations
- Seed/demo data (if applicable) functions and can be re-run
- CRUD endpoints for Villages, Plants, Tasks, Logs, Settings implemented per spec
- OpenAPI docs show correct schemas and examples
- Seed script produces 3 villages, 12 plants, 30 tasks
- Coverage >= 80% for services and routers
...
3. Populate `artifacts/Phase-01_Data_Model_and_CRUD/summary.json` with `"status":"partial"` and list TODOs.
