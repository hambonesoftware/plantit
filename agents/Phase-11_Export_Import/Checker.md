# Export / Import — Checker Agent

## Goal
Verify the Export / Import work meets acceptance criteria and global guardrails.

## Inputs
- Repo after execution.
- Artifacts: `artifacts/Phase-11_Export_Import/summary.json` (if present).
- Global Guardrails.
...
## Required Output
Produce a **`checker_report_Phase-11_Export_Import.md`** with:
